...
import TemplateBusiness from "./pages/template-business";
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/templatefashionstyle" element={<TemplateBusiness />} />
      <Route path="/aboutpage" element={<ContactPage />} />
      <Route path="/aboutpage1" element={<AboutPage />} />
